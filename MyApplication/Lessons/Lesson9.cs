...
internal class Lesson9
{
    ...
    /*
     Protect acess modifier can only be seen within the type or a child(derived) class.
     */
    ...
    /*
     Private Protected can be seen only within the class and child(derived) class from *within* the assembly
     */
