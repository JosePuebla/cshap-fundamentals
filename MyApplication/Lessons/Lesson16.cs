...
internal class Lesson16
{
    ...
    /*
     The List<T> is the same as an ArrayList, but we define our type
    in it delcaration as all items are of the same type.
     */
    public void MyListExample()
    {
        ...
        //myStringList.Clear();  will remove everything
    ...
    // This collections is based around key value pairs
